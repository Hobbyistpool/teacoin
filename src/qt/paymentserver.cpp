...
const QString BITCOIN_IPC_PREFIX("teacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click teacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start teacoin: click-to-pay handler");
    else
